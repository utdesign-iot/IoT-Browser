...
//This is the camera preview class which gives the user a visual of what the camera is scanning.
public class QCamP extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    public QCamP(Context context, Camera camera, Camera.PreviewCallback previewCallback)
    {
        super(context);
        init(camera, previewCallback);
    }

    public QCamP(Context context, AttributeSet attrs, Camera camera, Camera.PreviewCallback previewCallback)
    {
        super(context, attrs);
        init(camera, previewCallback);
    }
    ...
    //auto setup of the camera parameter based on device.
    ...
    //adjust the view size of the qr reader.
    ...
    //convert the size of the qr reader window to the Landscape orienation.
    ...
    //set the view size of the qr scanner.
    ...
    //get the display orientation from device.
    ...
    //get the optimal view size based on size of parent activity size.
